...
- Вторая сцена
- Перекат
- Скорость игры и ее максимальное значение - SerializedField
- время работы перков - SerializedField
- перк неуязвимости, который пропадает при получении урона
- таблица рекордов топ-3 со временем установки реконда и счетом
